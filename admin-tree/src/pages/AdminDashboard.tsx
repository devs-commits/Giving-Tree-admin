...
const AdminDashboard: React.FC = () => {
  ...
  const wishes: Wish[] = [
    { id: 1, title: 'School Supplies for 100 Students', currentDonations: 7500, requiredDonations: 10000, charityName: 'Education For All' },
    { id: 2, title: 'Winter Clothing Drive', currentDonations: 3200, requiredDonations: 5000, charityName: 'Hope Foundation' },
    { id: 3, title: 'Medical Equipment Fund', currentDonations: 15000, requiredDonations: 20000, charityName: 'Medical Aid Society' },
    { id: 4, title: 'Food Security Program', currentDonations: 4500, requiredDonations: 8000, charityName: 'Children\'s Relief Fund' },
  ];

  const donations: Donation[] = [
    { id: 1, accountNumber: 'ACC-10234', charityName: 'Hope Foundation', wishName: 'Winter Clothing Drive', amount: 500, quantity: 2, date: '2025-11-15' },
    { id: 2, accountNumber: 'ACC-10567', charityName: 'Education For All', wishName: 'School Supplies for 100 Students', amount: 1500, quantity: 5, date: '2025-11-14' },
    { id: 3, accountNumber: 'ACC-10892', charityName: 'Medical Aid Society', wishName: 'Medical Equipment Fund', amount: 2000, quantity: 1, date: '2025-11-13' },
    { id: 4, accountNumber: 'ACC-10123', charityName: 'Children\'s Relief Fund', wishName: 'Food Security Program', amount: 750, quantity: 3, date: '2025-11-12' },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className='flex justify-between'>
          <div className="mb-8">
            ...
            <p className="text-gray-600">Manage your charities, wishes, and donations</p>
          </div>
          <LogOut onClick={handleLogout} className="w-6 h-6 text-gray-600 cursor-pointer mt-5" />
        </div>
